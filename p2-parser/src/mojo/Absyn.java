...
public abstract class Absyn {
    ...
    public static abstract sealed class Type extends Node {
        ...
        public abstract static class Text {
            public static final Ref T
                = new Ref(ID("Text"), new Array(ID("ref array of byte"),
                                                null, Byte.T));
            static void init() {
    ...
    public static abstract sealed class Value extends Node {
        ...
        public interface Visitor<R> { R visit(Value v); }
    ...
    private static void print (Node n, int i) {
        ...
        case Expr.Text e -> {
            try {
                say(e.token); say(" (* ");
                for (byte b : e.value.getBytes("UTF-8")) {
