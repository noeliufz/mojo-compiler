...
public interface Tree {
    ...
    public sealed interface Exp extends Tree {
         ...
         */
        public record MEM(Exp exp, CONST offset, int size, boolean signed) implements Exp
        {
            public MEM(Exp exp, CONST offset, int size) { this(exp, offset, size, false); }
            public Exp[] kids() { return new Exp[] { exp }; }
            public Exp build(Exp[] kids) { return new MEM(kids[0], offset, size, signed); }
        }
        /**
